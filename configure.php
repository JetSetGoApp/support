...
$authorName = ask('Author name', 'JetSetGo Team');
$authorEmail = ask('Author email', 'developers@jetsetgo.com');

$vendorNamespace = ask('Vendor namespace', 'JetSetGo');
$vendorUsername = ask('Vendor username', 'JetSetGoApp');
